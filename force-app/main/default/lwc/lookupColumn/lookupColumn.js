...
export default class LookupColumn extends LightningElement {
    ...
    renderedCallback() {
        console.log('Record in Lookup ',this.record);
        console.log('Record in Field ',this.fields);
        console.log('Record in Value ',this.value);
        Promise.all([
    ...
    handleChange(event) {
        ...
        console.log('selected value on UI ',this.value);
